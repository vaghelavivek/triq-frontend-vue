            ...
            <div class="card mt-4">
              <div class="card-body p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Sign in to continue to E-TRIQ.</p>
                </div>
                <div class="p-2 mt-4">
                  <b-alert v-model="authError" variant="danger" class="mt-3" dismissible>{{ authError }}</b-alert>
                  <b-alert v-model="successMessage" variant="success" class="mt-3" dismissible>{{ successMessage }}</b-alert>
                  <div>
