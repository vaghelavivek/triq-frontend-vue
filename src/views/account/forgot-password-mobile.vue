<template>
  <div class="auth-page-wrapper pt-5">
          ...
          <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card mt-4">
              <div class="card-body p-4">
                ...
                <div class="p-2 mt-4">
                  <form v-if="!showPassowordFrom">
                    <div class="">
                      <div v-if="isMessageSend == false">
                        <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" placeholder="Enter otp" v-model="otp" />
    ...
    <!-- end Footer -->
    <div id="recaptcha-container-mobile-forgotpassword"></div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions({
      resetPasswordMobile:'auth/resetPasswordMobile',
    ...
    initReCaptcha(){
      setTimeout(()=>{
           const auth = getAuth();
          window.recaptchaVerifier = new RecaptchaVerifier('recaptcha-container-mobile-forgotpassword', {
              'size': 'invisible',
              'callback': () => {
    ...
    showForm(data){
      this.loader=false
        this.disabled=false
        this.showPassowordFrom=true
        this.user.token=data.accessToken
        this.user.phone=this.firebase.phone
    },
    resetPassword() {
      this.submitted = true;
      ...
      if (this.v$.user.$invalid) {
        ...
        this.loader=true
        this.disabled=true
        this.resetPasswordMobile(this.user).then((res)=>{
        this.loader=false
        this.disabled=false
        if(res.data.status){
             this.$toast.open({
